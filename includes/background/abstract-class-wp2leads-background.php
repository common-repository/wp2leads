...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
    include_once plugin_dir_path(  WP2LEADS_PLUGIN_FILE ) . 'vendor/wp-background-processing/classes/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
    include_once plugin_dir_path(  WP2LEADS_PLUGIN_FILE ) . 'vendor/wp-background-processing/classes/wp-background-process.php';
}

abstract class Wp2leads_Background_Process extends WP_Background_Process {
...
//        $this->log( 'handle unlock_process' );
//        $this->log( '===========================================' );
